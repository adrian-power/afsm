...
setwd("F:/Documents/Mush/Analysis")
...
* Added open code repository: [https://github.com/adrian-power/afsm](https://github.com/adrian-power/afsm)  
...
**Source:** https://en.wikipedia.org/wiki/Omphalotus_nidiformis: [13] Maguire, Garry (9 December 2011). "Luminous Ghost Fungus". Springbrook, Queensland: Springbrook Research Centre. [35] Young, T. (1996). "Some more records of fungi used as food by animals in Australia" (PDF). Australasian Mycologist. 15 (1): 8–9.
...
Data for the comparison regions includes all research grade (RG) observations from 'East Asia', 'Northern Europe', Canada and New Zealand as of September 2022. A summary of the overlap of species between regions is provided below. 
...
\newpage
\footnotesize
## How to take photos of fungi for identification purposes
...
![Comparison of fungi observations for identifcation purposes](fungi_photo_guide_comparison_1_adrian_power.jpg){width=75%} 
...
```
## Open Code
The source code for the report is available here: [https://github.com/adrian-power/afsm](https://github.com/adrian-power/afsm)  

## Copyright
This work, including the [source code](https://github.com/adrian-power/afsm) is licensed under a [Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International License](http://creativecommons.org/licenses/by-nc-nd/4.0/).
